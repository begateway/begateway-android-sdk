...
public enum CardType {
    ...
    MASTERCARD("^(5[1-5]|222[1-9]|22[3-9]|2[3-6]|27[0-1]|2720)\\d*",
            ...
            16, 16,
            3, R.string.begateway_cvc, null),
    MASTER("^(5[1-5]|222[1-9]|22[3-9]|2[3-6]|27[0-1]|2720)\\d*",
            R.drawable.begateway_ic_mastercard,
            16, 16,
            3, R.string.begateway_cvc, null),
    DISCOVER("^(6011|65|64[4-9]|622)\\d*",
            ...
            16, 16,
            3, R.string.begateway_cid, null),
    AMEX("^3[47]\\d*",
            R.drawable.begateway_ic_amex,
            15, 15,
            4, R.string.begateway_cid, null),
