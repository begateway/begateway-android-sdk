...
import com.begateway.mobilepayments.utils.ColorUtils;
...
public class CardScanningFragment extends Fragment {
    ...
    public static final String TAG = "com.bepaid.mobilepayments.CardScanningFragment";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent scanIntent = new Intent(getActivity(), CardIOActivity.class)
                ...
                .putExtra(CardIOActivity.EXTRA_GUIDE_COLOR,
                        ColorUtils.getColor(getActivity(), "colorAccent", R.color.begateway_blue));
