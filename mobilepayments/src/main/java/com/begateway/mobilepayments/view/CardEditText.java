...
import com.begateway.mobilepayments.utils.CardNumberTransformation;
...
public class CardEditText extends ErrorEditText implements TextWatcher {
    ...
    private void init() {
        ...
        setCardIcon(R.drawable.begateway_ic_unknown);
    ...
    public String getErrorMessage() {
        if (TextUtils.isEmpty(getText())) {
            return getContext().getString(R.string.begateway_card_number_required);
        } else {
            return getContext().getString(R.string.begateway_card_number_invalid);
        }
    }
