...
import com.begateway.mobilepayments.utils.ExpirationDateDialogTheme;
import com.begateway.mobilepayments.utils.ExpirationDateItemAdapter;
...
public class ExpirationDateDialog extends Dialog implements DialogInterface.OnShowListener {
    ...
    public static ExpirationDateDialog create(Activity activity, ExpirationDateEditText editText) {
        ...
        dialog = new ExpirationDateDialog(activity, R.style.begateway_expiration_date_dialog_light);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.begateway_expiration_date_sheet);
        ...
        GridView monthsGridView = findViewById(R.id.begateway_expiration_month_grid_view);
        ...
        mYearGridView = findViewById(R.id.begateway_expiration_year_grid_view);
